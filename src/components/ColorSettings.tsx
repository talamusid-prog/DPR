...
const ColorSettings = () => {
  ...
  const saveTheme = () => {
    ...
    toast({
      title: "Tema Disimpan",
      description: "Pengaturan warna telah disimpan dan diterapkan.",
    });
  };
  ...
  const handleImportTheme = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        toast({
          title: "Tema Diimpor",
          description: "Tema berhasil dimuat dari file.",
        });
      } catch (error) {
        toast({
          title: "Error",
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Pengaturan Warna</h1>
        </div>
        ...
        <TabsContent value="import-export" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Simpan atau muat konfigurasi tema dari file
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <Button onClick={handleExportTheme} className="flex-1">
                  <Download className="w-4 h-4 mr-2" />
                  Export Tema
                </Button>
                <div className="flex-1">
                  <Label htmlFor="import-theme" className="sr-only">
                    Import Tema
                  </Label>
                  <Input
                    id="import-theme"
