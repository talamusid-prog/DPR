...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted">
      <Helmet>
        {/* Basic Meta Tags */}
        <title>Galeri Komunitas Pemuda NTB | Menjaga Warisan, Membangun Masa Depan</title>
        ...
        <meta name="keywords" content="galeri, foto, komunitas pemuda NTB, Nusa Tenggara Barat, budaya, alam, pantai, Lombok, galeri masonry" />
        
        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="Galeri Komunitas Pemuda NTB | Menjaga Warisan, Membangun Masa Depan" />
        ...
        <meta property="og:site_name" content="Komunitas Pemuda NTB" />
        ...
        <meta property="og:image:alt" content="Galeri Komunitas Pemuda NTB" />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:secure_url" content="https://komunitaspemudantb.org/logo.png" />
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Galeri Komunitas Pemuda NTB | Menjaga Warisan, Membangun Masa Depan" />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-secondary mb-4">
            Galeri Masonry Komunitas Pemuda NTB
          </h1>
