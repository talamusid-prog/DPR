-- Gallery Images Table untuk Komunitas Pemuda NTB
...
('Budaya Sasak Tradisional', 'Pertunjukan tari tradisional Sasak dalam acara budaya komunitas pemuda NTB', 'budaya-sasak-tradisional', 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?q=80&w=2070&auto=format&fit=crop', 'Mataram, NTB', 'Budaya', 'Komunitas Pemuda NTB', 'published', false),
...
-- Comment pada tabel
COMMENT ON TABLE gallery_images IS 'Tabel untuk menyimpan foto-foto galeri komunitas pemuda NTB';
