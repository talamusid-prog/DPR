-- Gallery Images Table untuk IKKBG Pasangkayu
...
('Budaya Sasak Tradisional', 'Pertunjukan tari tradisional Sasak dalam acara budaya IKKBG Pasangkayu', 'budaya-sasak-tradisional', 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?q=80&w=2070&auto=format&fit=crop', 'Mataram, NTB', 'Budaya', 'IKKBG Pasangkayu', 'published', false),
...
-- Comment pada tabel
COMMENT ON TABLE gallery_images IS 'Tabel untuk menyimpan foto-foto galeri IKKBG Pasangkayu';
